...
const useSounds = ()=>{
    ...
    return {
        ...
        setVolume,
        sounds: {
            playCardPlace: ()=>soundsEnabled && console.log('🎵 Card place sound'),
            playCardFlip: ()=>soundsEnabled && console.log('🎵 Card flip sound'),
            playAttack: ()=>soundsEnabled && console.log('🎵 Attack sound'),
            playDefense: ()=>soundsEnabled && console.log('🎵 Defense sound'),
            playWin: ()=>soundsEnabled && console.log('🎵 Win sound'),
            playLose: ()=>soundsEnabled && console.log('🎵 Lose sound'),
            playPackOpen: ()=>soundsEnabled && console.log('🎵 Pack open sound'),
            playButton: ()=>soundsEnabled && console.log('🎵 Button sound'),
            playNotification: ()=>soundsEnabled && console.log('🎵 Notification sound')
        }
    };
};
}),
...
//# sourceMappingURL=src_12kkwa-._.js.map